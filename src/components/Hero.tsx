...
export const Hero = () => {
    ...
    return (
        <section
            className="
                relative w-full overflow-hidden bg-[#050b16] py-28
            "
        >
            <div
                className="
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div ref={wrapperRef} className="hero-3d-wrapper relative w-full max-w-[720px] h-[640px] lg:h-[720px] flex items-center justify-center">
                        ...
                        <div ref={cardRef} className="hero-card">
                            <div className="card-inner w-[320px] h-[520px] mx-auto bg-gradient-to-br from-[#0096D6] to-[#44B78B] rounded-[60px] shadow-2xl flex items-center justify-center relative overflow-hidden group transform transition-transform hover:scale-105 duration-500">
