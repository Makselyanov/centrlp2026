...
export const Hero = () => {
    ...
    return (
        <section className="relative overflow-hidden bg-[#050b16] text-slate-50 py-28">
            {/* НЕОНОВЫЙ ФОН НА ВЕСЬ HERO */}
            <div className="hero-3d-wrapper pointer-events-none absolute inset-0">
                <div className="webgl" data-us-project="SQfSNwh8RxqcNhnvfl18" />
            </div>

            {/* КОНТЕНТ СВЕРХУ ФОНА */}
            <div className="relative z-10 container mx-auto flex flex-col lg:flex-row items-center gap-12">
                {/* Левая колонка с текстом как у тебя было */}
                ...
                {/* Правая колонка с карточкой AI POWER */}
                <div className="flex-1 flex justify-center">
                    <div ref={cardRef} className="hero-card">
                        <div className="card-inner w-[320px] sm:w-[360px] lg:w-[400px] h-[520px] rounded-[48px] bg-gradient-to-br from-[#80e9ff] to-[#49d6a3] shadow-2xl flex items-center justify-center relative overflow-hidden group transform transition-transform hover:scale-105 duration-500">
