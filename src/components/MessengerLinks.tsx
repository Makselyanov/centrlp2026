...
const links: Array<{
...
}> = [
  {
    ...
    className: "bg-[#0067C5] text-white hover:bg-[#0057A8]",
    icon: (
      <img
        src={maxMark}
        alt=""
  ...
  },
  {
    ...
    label: "Telegram",
    href: TELEGRAM_URL,
    className: "bg-[#006A9F] text-white hover:bg-[#005A88]",
    icon: (
  ...
  },
  {
    ...
    label: "WhatsApp",
    href: WHATSAPP_URL,
    className: "bg-[#137333] text-white hover:bg-[#0F5F2A]",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    label: "VK",
    href: VK_URL,
    className: "bg-[#005FCC] text-white hover:bg-[#0050AD]",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
