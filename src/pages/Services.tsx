...
const growthServices: ServiceCard[] = [
  ...
  {
    title: "План маркетинга и стратегия",
    description: "План маркетинга для Тюмени и онлайн-продаж: цена входа, каналы, офферы, карта гипотез и приоритеты запуска.",
    href: "/services/marketing-strategy",
    bullets: ["Цена от 35 000 ₽", "Сегменты и офферы", "Гипотезы роста"],
    icon: Target,
  },
  {
    title: "Веб-аналитика",
...
const Services = () => {
  ...
  return (
    <Layout
      title="Услуги CentrLP в Тюмени — сайты, CRM, AI-агенты и заявки"
      description="Услуги CentrLP в Тюмени: сайты под заявки, CRM для бизнеса, AI-агенты, OpenClaw, n8n, Яндекс.Директ, аналитика и упаковка цифровых продуктов."
    >
