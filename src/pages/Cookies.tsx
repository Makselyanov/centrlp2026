          ...
          <div className="prose max-w-none text-muted-foreground space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                с уведомлением об использовании cookie. Срок хранения: 1 год.
              </li>
              <li>
                <strong>session-id</strong> (Оператор) — поддерживает сессию Пользователя.
            ...
            <p>
              4.2. Продолжение использования Сайта после ознакомления с уведомлением
              означает согласие Пользователя на использование cookie в соответствии
              с настоящей Политикой.
            </p>
            <p>
              4.3. Пользователь вправе в любой момент отозвать своё согласие путём
              отключения cookie в настройках браузера в соответствии с разделом 5
              настоящей Политики.
            </p>
