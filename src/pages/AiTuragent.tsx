...
export default function AiTuragent() {
  ...
  return (
    <Layout
      ...
      description="Автоматизация сопровождения туристов: ваучеры, напоминания, допродажи страховки и трансфера, ответы на типовые вопросы. Работает в ВКонтакте, Telegram и MAX. Внедрение от 29 000 ₽."
    >
      {/* =====================================================================
          HERO
         ===================================================================== */}
