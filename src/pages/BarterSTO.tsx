...
const BarterSTO = () => {
  return (
    <Layout
      title="Бартер для СТО и автоуслуг — сайт, ВК и реклама | CentrLP"
      description="Взаимозачёт для автосервиса: сайт, квиз, ВКонтакте, реклама и аналитика в обмен на работы по авто, детейлинг или доработки."
    >
      <section
