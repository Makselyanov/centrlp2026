...
const repairJobs: RepairJob[] = [
  ...
  },
  {
    ...
    result: "AMG получает сайт amg-antikor72.ru как часть бартерной работы по антикору. Со стороны сервиса обсуждается пескоструй днища, антикор и обработка скрытых полостей Pajero.",
    price: 100_000,
    priceLabel: "согласованный пакет около 100 000 ₽",
    breakdown: "Встречная работа уже собрана как отдельный сайт под AMG Antikor 72. Для сравнения рядом показан 0rs.ru как образец сайта-каталога, который можно использовать в переговорах о формате и объёме бартерного пакета.",
    ...
    images: [
      ...
      },
      {
        ...
        caption: "Сайт amg-antikor72.ru подготовлен как часть бартерной работы по антикору.",
        sourceUrl: "https://amg-antikor72.ru/",
      },
      {
        src: "/images/barter/pajero/0rs-site-preview.png",
        alt: "Сайт 0rs.ru как образец сайта-каталога для бартерного предложения",
        caption: "0rs.ru — образец сайта-каталога: структура услуг, страницы, заявки и понятная упаковка предложения.",
        sourceUrl: "https://0rs.ru/",
      },
    ],
  },
  {
