...
const valueStack = [
  ...
  },
  {
    ...
    text: "Состав фиксируется под смету сервиса: от одного понятного направления до полного пакета сайта, ВК, рекламы и аналитики.",
  },
];
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="max-w-2xl text-xl leading-9 text-slate-200">
                ...
                автоуслуг. Стоимость пакета фиксируется по смете, рекламный бюджет считается отдельно.
              </p>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
                  <div className="text-sm font-semibold text-primary">Расчёт</div>
                  <div className="mt-2 text-sm leading-6 text-slate-200">По рыночной стоимости работ и составу маркетингового пакета</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-border/50 bg-background/90 p-5">
              ...
              <div className="mt-2 text-base text-foreground">Сначала смета сервиса, затем маркетинговый пакет под сопоставимый эквивалент.</div>
            </div>
            <div className="rounded-2xl border border-border/50 bg-background/90 p-5">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <p className="max-w-2xl text-lg leading-8 text-muted-foreground">
                Не просим скидку и не размываем условия. Фиксируем две понятные ценности:
                автоработы по смете и маркетинговый пакет CentrLP с сопоставимым эквивалентом.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              ...
              <h2>Не обмен “подешевле”, а пакет с понятной ценностью</h2>
            </div>
            <p className="text-lg leading-8 text-muted-foreground">
              Стоимость работ фиксируем не на глаз: сайт, ВК, бот, реклама и аналитика имеют отдельные
              цены. Поэтому состав бартера можно собрать под реальную смету сервиса: от одного
              направления до полноценной упаковки с рекламной сборкой.
            </p>
          </div>
          ...
          <div className="mt-14">
            <div className="mb-6 max-w-3xl">
              ...
              <p className="mt-3 text-base leading-7 text-muted-foreground">
                Сервис показывает состав работ, CentrLP показывает состав маркетингового пакета.
                До старта фиксируем сроки, результат, отдельные расходы и критерии приёмки.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-primary/15 bg-gradient-to-br from-primary/10 via-background to-accent-2/10 p-8 md:p-10 text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">
              ...
              квиза, ВК, рекламы и аналитики на согласованную сумму. Если логика совпадает,
              фиксируем этапы и работаем как партнёры.
            </p>
