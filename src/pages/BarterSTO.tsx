...
const offerCards = [
  {
    ...
    text: "Не визитка “про всё”, а страница под ГБО, плёнку, антикор, автозвук и камеры с нормальным оффером.",
  },
  {
    title: "Квиз и форма под заявки",
    text: "Марка авто, задача, удобный способ связи и быстрый вход в диалог без лишних шагов.",
  },
  {
...
const BarterSTO = () => {
  return (
    <Layout
      ...
      description="Бартер с автосервисом: сайт, квиз, реклама и заявки в обмен на услуги по авто. Страница для владельцев СТО, детейлинга, ГБО, плёнки, автозвука и антикоррозийных работ."
    >
      <section
        ...
        <div className="container relative mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="relative">
              ...
              <img
                src="/images/barter/sto-barter-loop.svg"
          ...
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <p className="max-w-2xl text-lg leading-8 text-muted-foreground">
                Для владельца СТО важно не красивое описание услуг, а ясный список работ: что будет
                сделано, как это приведёт клиента и где именно вы увидите результат.
              </p>
            ...
            <div className="space-y-6">
              <img
                src="/images/barter/sto-offer-stack.svg"
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
            <div className="order-2 lg:order-1">
              <img
                src="/images/barter/sto-lead-path.svg"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <img
              src="/images/barter/sto-service-grid.svg"
      ...
      <section id="benefits" className="bg-card py-20">
        <div className="container mx-auto px-4">
          <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
            ...
            <img
              src="/images/barter/sto-fit-check.svg"
