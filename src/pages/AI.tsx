...
const aiModules = [
  ...
  {
    icon: FileText,
    title: "Черновики и документы",
    text: "Нейросеть помогает собрать черновик КП, письмо, структуру статьи, пост или отчет, используя данные клиента и правила компании.",
  },
  {
    icon: LineChart,
...
const routeSteps = [
  ...
  },
  {
    step: "03",
    title: "Нейросеть",
    text: "AI делает резюме, подсказывает следующий шаг, готовит черновик и отмечает риск.",
  },
  {
    step: "04",
    title: "Человек",
...
const implementationSteps = [
  ...
  },
  {
    ...
    text: "Подключаем разбор звонков, резюме карточки, подсказки менеджеру, отчеты, Контент Завод и AI-черновики.",
  },
  {
    icon: Rocket,
        ...
        <div className="container mx-auto px-4">
          <motion.div className="mx-auto mb-12 max-w-3xl text-center" {...fadeInUp}>
            ...
            <p className="text-lg leading-8 text-slate-600">
              ...
              человеком. AI готовит контекст и черновик, чтобы менеджер быстрее принимал решение.
            </p>
          </motion.div>
