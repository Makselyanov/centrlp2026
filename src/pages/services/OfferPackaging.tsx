...
const OfferPackaging = () => {
  const faqItems = [
    { question: "Сколько стоит упаковка оффера?", answer: "Полная упаковка оффера под ключ — от 25 000 ₽. В стоимость входит анализ конкурентов, разработка 3–5 вариантов офферов, формулировка бонусов и гарантий, рекомендации по внедрению на сайт и в рекламу." },
          ...
          <div className="max-w-md mx-auto">
            <Card className="relative hover:shadow-2xl transition-all duration-300 border-primary shadow-lg bg-background">
              ...
              <CardHeader className="text-center">
                ...
                <div className="text-4xl font-bold text-primary mt-2">от 25 000 ₽</div>
