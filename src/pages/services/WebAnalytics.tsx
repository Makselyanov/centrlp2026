...
const WebAnalytics = () => {
  const faqItems = [
    { question: "Сколько стоит заказать настройку веб-аналитики для сайта?", answer: "Базовая настройка начинается от 15 000 ₽ и обычно занимает 3–5 рабочих дней. В неё входят проверка счётчика, цели для формы, телефона и мессенджеров, UTM-разметка, контрольная заявка и проверка, что источник обращения сохраняется. Интеграции с CRM, коллтрекинг и сквозная аналитика рассчитываются отдельно после проверки текущего маршрута заявки." },
    { question: "С какой системы аналитики начать?", answer: "Выбор зависит от рекламных каналов и задач. Для связки с Яндекс Директом обычно начинают с Яндекс Метрики, целей и UTM. GA4 подключают, если он нужен для других источников, командных отчётов или международного контура. До установки фиксируем, какие решения должны поддерживать данные." },
    ...
    { question: "Как принять настройку веб-аналитики?", answer: "Проверяем тестовую ссылку с UTM и контрольную заявку. Успешная отправка должна считаться отдельно от нажатия кнопки и ошибки, телефон и мессенджеры — отдельными событиями, параметры источника — сохраняться, а обращение — доходить до ответственного, CRM или журнала заявок." },
    { question: "Какие доступы и данные нужны для настройки?", answer: "Для расчёта достаточно ссылки на сайт, списка рекламных каналов и описания, куда сейчас приходят заявки. После согласования работ понадобятся отдельные доступы к Метрике, сайту или менеджеру тегов и, если входит в объём, к CRM. Пароли передавать не нужно: используем приглашения с минимально необходимыми правами, а счётчики, цели и отчёты остаются в аккаунтах заказчика." },
  ];
  ...
  return (
    <Layout
      ...
      description="Закажите настройку веб-аналитики для сайта от 15 000 ₽: Яндекс Метрика, цели, события, UTM, контрольная заявка и связь с CRM. Срок базовой настройки — 3–5 дней."
    >
      {/* Hero Block */}
          ...
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button size="lg" className="text-lg px-8" asChild>
                <a href="?intent=web-analytics#contact">Заказать настройку веб-аналитики от 15 000 ₽</a>
              </Button>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  Для сайта, который работает с российской аудиторией и Яндекс Директом, обычно начинаем с Яндекс Метрики. GA4 рассматриваем отдельно для международного трафика и экосистемы Google. Подключать две системы «для полноты» не обязательно: сначала определяем вопросы бизнеса, требования к данным и допустимые сервисы.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  Без целей вы видите посещаемость, но не различаете важные действия. Цели фиксируют успешную форму, звонок, переход в мессенджер или другое согласованное событие. Достижение цели ещё не доказывает, что человек стал клиентом: реальные обращения, спам, тесты и продажи нужно сверять с журналом заявок или CRM.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5" className="border rounded-lg px-6">
                ...
                <AccordionContent className="text-muted-foreground">
                  Да, если CRM сохраняет источник, статусы и результат обработки, а сайт или рекламная система передают подходящие идентификаторы. Состав интеграции зависит от API, прав доступа и качества данных. До расчёта фиксируем, какие этапы можно подтвердить технически; полную атрибуцию и совпадение всех визитов со сделками не обещаем.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Пришлите сайт, формы и рекламные каналы. Определим, достаточно ли базовых целей, нужен расширенный отчёт или связка с CRM, и зафиксируем проверяемый состав работ.
            </p>
            <p className="mt-4 text-base text-muted-foreground">
              Для первого расчёта не нужны пароли: достаточно ссылки на сайт, списка источников трафика и описания, куда приходят заявки. Доступы запрашиваем после согласования — через приглашения с минимальными правами; счётчики, цели и отчёты остаются в аккаунтах заказчика.
            </p>
          </div>
          <ContactForm />
        </div>
