...
const DesignPrototypingPage = () => {
  ...
  return (
    <Layout
      ...
      description="Разрабатываем интерфейсы с упором на аналитику и поведение. Создаем дизайн, который ведет пользователя к покупке, а не просто выглядит красиво. Тестируем гипотезы."
    >
      {/* Hero */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left animate-fade-in">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Исследуем аудиторию, строим CJM и проверяем гипотезы через AI.
                Создаем дизайн, который снижает стоимость заявки и увеличивает
                продажи.
              </p>
              ...
              <div className="flex flex-col gap-3 mb-8 max-w-md mx-auto lg:mx-0">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-3 text-muted-foreground bg-background/50 p-2 rounded-lg border border-transparent hover:border-accent/20 transition-colors"
                  >
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="bg-background p-6 rounded-xl shadow-sm hover:shadow-md transition-all hover-scale"
              >
            ...
            {[
              ...
              <div
                ...
                className={`relative p-8 rounded-2xl ${
                  plan.popular
                    ? "bg-accent text-accent-foreground shadow-2xl scale-105"
