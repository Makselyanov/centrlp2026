...
const ContentPlan = () => {
  const faqItems = [
    { question: "Сколько стоит контент-план для соцсетей в Тюмени?", answer: "Контент-план стоит от 25 000 ₽/мес. Ведение соцсетей с текстами и публикацией — от 45 000 ₽/мес. Комплекс «контент + реклама» — от 65 000 ₽/мес без рекламного бюджета. Финальная цена зависит от количества площадок и объёма работ." },
