...
const ContentPlan = () => {
  const faqItems = [
    { question: "Сколько стоит контент-план на месяц для бизнеса в Тюмени?", answer: "Контент-план на месяц стоит от 25 000 ₽. Ведение соцсетей с текстами и публикацией — от 45 000 ₽/мес. Комплекс «контент + реклама» — от 65 000 ₽/мес без рекламного бюджета. Финальная цена зависит от количества площадок и объёма работ." },
  ...
  const pricingTiers = [
    {
      name: "Контент-план", price: "от 25 000 ₽/мес", desc: "База для самостоятельного ведения",
      features: ["20–30 тем и форматов", "Рубрикатор и матрица", "Календарь публикаций", "Рекомендации по визуалу"],
      highlighted: false,
    },
    {
      name: "План + Ведение", price: "от 45 000 ₽/мес", desc: "Мы пишем и публикуем за вас",
      features: ["Всё из «Контент-плана»", "Написание текстов", "Публикация (постинг)", "Ответы на комментарии", "Ежемесячный отчёт"],
      highlighted: true,
    },
    {
      name: "Контент + Реклама", price: "от 65 000 ₽/мес", desc: "Комплексный подход к продажам",
  ...
  return (
    <Layout
      title="Контент-план на месяц в Тюмени от 25 000 ₽ | CentrLP"
      description="Закажите контент-план на месяц для бизнеса в Тюмени от 25 000 ₽: рубрики, темы, календарь, форматы, CTA, референсы и аналитика для VK и Telegram."
    >
      {/* ── Hero ─────────────────────────────────────────────────────── */}
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden bg-gradient-to-b from-white via-[#0096D6]/[0.04] to-white">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 mb-6 leading-[1.1]">
            Контент-план на месяц для бизнеса <br />
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
            От 25 000 ₽ за месячный план: рубрики, темы, даты, форматы, CTA и референсы для VK и Telegram. AI помогает анализировать тренды, а смыслы и воронки прописываем вручную.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
            <Button size="lg" onClick={scrollToForm}>
              Заказать план на месяц от 25 000 ₽
            </Button>
