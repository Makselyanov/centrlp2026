...
const MarketingStrategy = () => {
  const faqItems = [
    ...
    { question: "Что нужно прислать для расчёта плана маркетинга?", answer: "Достаточно указать нишу, город или регион продаж, 1–2 приоритетные услуги, текущие источники заявок и ориентир по бюджету на тест. Если есть сайт, рекламные кабинеты или CRM, добавьте ссылки и кратко опишите, где сейчас теряются обращения. По этим данным можно подтвердить подходящий формат, состав и стоимость работы." },
  ];
  ...
  const acceptanceChecklist = [
    ...
    "Определена базовая точка: сколько подтверждённых заявок приходит сейчас и как сравнивать результат теста",
  ];
