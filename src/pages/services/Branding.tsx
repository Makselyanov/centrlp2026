...
export default function Branding() {
  const faqItems = [
    { question: "Сколько стоит разработка фирменного стиля в Тюмени?", answer: "Стоимость зависит от объёма работ. Базовый брендинг начинается от 25 000 ₽, фирменный стиль с носителями — от 45 000 ₽, полная бренд-система с брендбуком — от 75 000 ₽. На консультации определим оптимальный пакет под ваш бизнес." },
