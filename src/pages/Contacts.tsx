          ...
          <div className="grid min-w-0 gap-12 lg:grid-cols-2 lg:items-start">
            ...
            >
              <motion.div variants={fadeInUp}>
                <Card className="min-w-0 p-4 border-l-4 border-l-primary hover:shadow-md transition-shadow sm:p-6">
                  <div className="flex min-w-0 flex-col items-start gap-4 sm:flex-row">
                    ...
                    <div className="min-w-0">
                      ...
                      <a href="tel:+79058248564" className="mb-2 block whitespace-nowrap text-xl font-bold transition-colors hover:text-primary sm:text-2xl">
                        8-905-824-85-64
                      </a>
                      <div className="flex flex-wrap gap-3">
                        <Button size="sm" variant="outline" className="min-h-11 gap-2" onClick={() => window.open('https://t.me/centrlp', '_blank')}>
                          Telegram
                        </Button>
                        <Button size="sm" variant="outline" className="min-h-11 gap-2" onClick={() => window.open('https://wa.me/79058248564', '_blank')}>
                          WhatsApp
                        </Button>
                      </div>
                    </div>
              ...
              <motion.div variants={fadeInUp}>
                <Card className="min-w-0 p-4 border-l-4 border-l-accent-1 hover:shadow-md transition-shadow sm:p-6">
                  <div className="flex min-w-0 flex-col items-start gap-4 sm:flex-row">
                    <div className="shrink-0 bg-accent-1/10 p-3 rounded-full text-accent-1">
              ...
              <motion.div variants={fadeInUp}>
                <Card className="min-w-0 p-4 border-l-4 border-l-accent-2 hover:shadow-md transition-shadow sm:p-6">
                  <div className="flex min-w-0 flex-col items-start gap-4 sm:flex-row">
                    <div className="shrink-0 bg-accent-2/10 p-3 rounded-full text-accent-2">
                    ...
                    <div className="w-full">
                      ...
                      <div className="flex items-center gap-2 bg-secondary p-2 rounded-lg w-full max-w-xs">
                        ...
                        <Button size="icon" variant="ghost" className="h-11 w-11" onClick={copyInn}>
              ...
              <motion.div variants={fadeInUp}>
                <Card className="min-w-0 p-4 border-l-4 border-l-[#44B78B] hover:shadow-md transition-shadow sm:p-6">
                  <div className="flex min-w-0 flex-col items-start gap-4 sm:flex-row">
                    <div className="shrink-0 bg-[#44B78B]/10 p-3 rounded-full text-[#44B78B]">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {[
                          ...
                          <a
                            ...
                            className="inline-flex min-h-11 items-center gap-2 rounded-full border border-border bg-background px-3 py-2 text-sm font-semibold text-foreground transition-colors hover:border-primary/40 hover:text-primary"
                          >
                            {link.label}
            ...
            <motion.div
              ...
              className="min-w-0"
            >
              <Card className="min-w-0 p-4 shadow-lg border-primary/10 sm:p-8">
                <div className="mb-6">
      ...
      <section className="h-[400px] w-full bg-secondary relative overflow-hidden">
        {mapVisible ? (
          ...
          <div className="flex h-full flex-col items-center justify-center gap-4 bg-slate-100 px-4 text-center">
            ...
            <Button type="button" className="min-h-11" onClick={() => setMapVisible(true)}>
              Показать карту
            </Button>
          </div>
        )}
